...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Search photos using Pexels, Unsplash, and Flickr")
    ...
    parser.add_argument("--providers", nargs="*", help="Subset of providers (pexels unsplash flickr)")
